...
print(linkedList.insertAtMid(6,2))
print(linkedList.printListwithSize())


print(linkedList.delFromMid(3))
...
# print("##############")
# print("Details:-")
# print("getData() of this NODE is: ", self.head.getData())
# print("getNext() of this NODE is: ", self.head.getNext())
# print("next of this NODE is: ", self.head.next)
# print("##############")
